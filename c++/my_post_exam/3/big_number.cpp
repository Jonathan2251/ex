...
int main() {
    ...
    */
#else
    Bigint p("+102459981832441577303356");
    Bigint q("+800222888475144241606717");
    Bigint r(0);
    r = p + q;
    // r = 902682870307585
    cout << "(+102459981832441577303356) + (+800222888475144241606717) = " << r << "\n";

    Bigint q1("-800222888475144241606717");
    r = p + q1;
    // r = -697762906642703
    cout << "(+102459981832441577303356) + (-800222888475144241606717) = " << r << "\n";
#endif
